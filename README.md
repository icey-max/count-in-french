...
- Counting in Standard French from 1 to 100, then forming hundreds, thousands, millions, and billions.
- Hearing a Standard French number and typing the digits.
...
Some Standard French numbers are straightforward, like `un`, `deux`, `trois`, and `dix`. Others use patterns that can surprise English speakers.
...
Start at Level 1 and move through the numbers in small groups. Each level introduces a range, then asks you to answer from memory. You will see digits, hear audio, type Standard French spellings, and review mistakes until the numbers become easier to recall.
